 ...
 * 
 * That being said, I bring it once again to attention that when two matrices are combined for any operation using
 * the standalone operations of MatExpr class (such as mul, /, +, etc) a new matrix is always generated.
 *
