 ...
 *      [1] Each task runs in a hardware protected ring. We have Rings 0 to 3. Ring 0 is for OS, ring 3 for
 ...
 *          see figures 2 and 3, we see that each of them have an address to the next task as well.
 *      [3] TTS is different, but quite similar for 32 and 64 bit processors.
 *      [4] ONLY 32 bit processes have hardware switching between tasks. However, most OSs do the switching
 ...
 *      [6] In essence, this table is fed to the CPU and it will execute it in one CPU cycle.
 * 
 * 
 */