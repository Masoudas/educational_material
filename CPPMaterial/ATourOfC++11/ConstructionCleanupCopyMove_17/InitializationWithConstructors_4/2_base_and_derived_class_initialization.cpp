...
* every type. Bjarne says whenever we say T{v},  the same value of type T(T{v}) is created. This is
* not the case for = or () initialization. For example, below we can't say
* 
