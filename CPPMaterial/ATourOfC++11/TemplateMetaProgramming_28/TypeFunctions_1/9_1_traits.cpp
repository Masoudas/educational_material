...
* iterator that can be used in correctly with the std libraries, I needed to define alises such as ptr_difference,
* value_type, pointer, etc inside the definition of the iterator. The big guy now is talking about such traits, and in 
* fact he's going to talk about it more in the coming sections.
* 
...
* inside the iterator definiton. Then, we can use the iterator_traits function to access them.
* 
...
// for example, and not vector_iterator with no template parameter!
