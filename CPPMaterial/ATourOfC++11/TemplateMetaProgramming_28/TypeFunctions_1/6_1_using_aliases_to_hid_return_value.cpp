/**
* The big guy goes demonstrates his frustation with having to scope to type, and says regarding the stack or heap allocator
* we just implemented that "Note how the implementation details of Obj_holder (as for Int) shine through when we use 
...
* Note from me: Since C++14, such aliases are appended with _t, so it would be Obj_holder_t in this example. However, 
* prior to C++14, there were no such aliases in the standard, as the big guy indicates.
* 
*/