...
Me: Recall that full join inserts null and brings both tables, outer right join brings all the columns of the left, and puts none for the right, and inner join is our normal expectation from join, without setting any nulls.
...
# This is me: Docs say this outer join brings all those of the left table.
Select.select_from(user_table.c.name, address_table.c.email_address).join(
    user_table, user_table.c.name == address_table.c.name, isouter=True)
